...
def train_gan(input_noise_dim, batch_size, epochs, model_save_dir, output_dir):
    ...
    for epoch in range(epochs):
        ...
        for index in range(int(x_train.shape[0]/batch_size)):
            ...
            # print("EEEEEEEEEHHEEHE", real_images.shape, np.mean(real_images))
            # image = combine_rgb_images(real_images)
            # image = image * 255.0
            # img_save_path = os.path.join("./checksie/", str(epoch) + "_g_" + str(index) + ".png")
